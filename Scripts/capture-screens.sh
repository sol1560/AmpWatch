...
screens=(threads threads-grouped puck threads-empty threads-error threads-queued threads-over-cap detail detail-over-cap compose usage setup settings new-thread approval approval-destructive approval-deferred approval-expired phrases templates glance glance-spend)
